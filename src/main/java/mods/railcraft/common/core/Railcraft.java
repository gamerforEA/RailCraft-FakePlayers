...
@Mod(modid = Railcraft.MOD_ID,
	 ...
	 dependencies = "required-after:Forge@[10.13.4.1448,);" + "after:BuildCraft|Core[6.1.7,);" + "after:BuildCraft|Energy;" + "after:BuildCraft|Builders;" + "after:BuildCraft|Factory;" + "after:BuildCraftAPI|statements[1.0,);" + "after:BuildCraftAPI|transport[1.0,);" + "after:Forestry[3,);" + "after:Thaumcraft;" + "after:IC2@[2.2,)")
public final class Railcraft
{
	...
	@SidedProxy(clientSide = "mods.railcraft.client.core.ClientProxy",
	...
	public void missingMapping(FMLMissingMappingsEvent event)
	{
		for (FMLMissingMappingsEvent.MissingMapping mapping : event.get())
		{
			...
			else if (mapping.type == GameRegistry.Type.ITEM)
			{
				Block block = GameRegistry.findBlock(getModId(), MiscTools.cleanTag(mapping.name));
				if (block != null)
					this.remap(Item.getItemFromBlock(block), mapping);
					...
					this.remap(Item.getItemFromBlock(RailcraftFluids.CREOSOTE.getBlock()), mapping);
				else if (mapping.name.equals("Railcraft:tile.railcraft.block.fluid.steam") && RailcraftFluids.STEAM.getBlock() != null)
					this.remap(Item.getItemFromBlock(RailcraftFluids.STEAM.getBlock()), mapping);
				else if (mapping.name.equals("Railcraft:tile.block.firestone.recharge") && BlockFirestoneRecharge.getBlock() != null)
					this.remap(Item.getItemFromBlock(BlockFirestoneRecharge.getBlock()), mapping);
				else if (mapping.name.equals("Railcraft:tile.railcraft.block.anvil") && BlockRCAnvil.getBlock() != null)
					this.remap(Item.getItemFromBlock(BlockRCAnvil.getBlock()), mapping);
				else if (mapping.name.equals("Railcraft:tile.railcraft.hidden"))
					mapping.ignore();
				else if (mapping.name.equals("Railcraft:tile.railcraft.stonelamp"))
					this.remap(Item.getItemFromBlock(BlockLantern.getBlockStone()), mapping);
			}
		}
	}
