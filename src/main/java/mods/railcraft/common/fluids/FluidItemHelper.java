...
public class FluidItemHelper
{
	...
	public static DrainReturn drainContainer(ItemStack container, int maxDrain)
	{
		...
		if (container.getItem() instanceof IFluidContainerItem)
		{
			 ...
			 * https://github.com/CovertJaguar/Railcraft/commit/54a018a29d0de10f7f1db09dd1504f9979fea378
			...
			boolean overridesGetContainerItem = container.getItem().hasContainerItem(container);
